...
import {Port} from "../../parts/deck/port.js"
import {Deck} from "../../parts/deck/deck.js"
import {Bindings} from "../../parts/bindings.js"
import {Devices} from "../../parts/device/devices.js"
import {BindingsDataFrom} from "../../parts/types.js"
import {Controller} from "../../parts/deck/controller.js"
import {GamepadDevice} from "../../parts/device/gamepad.js"
import {PointerDevice} from "../../parts/device/pointer.js"
import {KeyboardDevice} from "../../parts/device/keyboard.js"
...
export type DemoBindingsData = BindingsDataFrom<typeof bindings>
...
export class DemoApp extends shadowElement(() => {
	...
	useMount(() => cycle(async() => {
		await nap(1000 / 20)
		const [port] = deck.ports
		const activity = port.resolveActivity(Date.now())
